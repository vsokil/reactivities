...
const ActivityListItem: React.FC<{ activity: IActivity }> = ({ activity }) => {
    ...
    return (
        <Segment.Group>
            <Segment>
                <Item.Group>
                    <Item key={activity.id}>
                        ...
                        <Item.Content>
                            <Item.Header as={List} to={`/activities/${activity.id}`}>{activity.title}</Item.Header>
                            <Item.Description>
            ...
            <Segment secondary>
                <ActivityListItemAttendees attendees={activity.attendees}></ActivityListItemAttendees>
            </Segment>
            <Segment clearing>
