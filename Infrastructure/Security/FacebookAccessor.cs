...
namespace Infrastructure.Security
{
    public class FacebookAccessor : IFacebookAccessor
    {
        ...
        {
            var verifyToken =
                await _httpClient.GetAsync($"debug_token?input_token={accessToken}&access_token={_config.Value.AppId}|{_config.Value.AppSecret}");
            ...
            var userInfo = await GetAsync<FacebookUserInfo>(accessToken, "me", "fields=name,email,picture.with(100).height(100)");
